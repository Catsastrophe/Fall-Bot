...
module.exports = {
    name: 'terms',
    guildOnly: true,
    description: "Read Fall Music's Terms of Service.",
    usage: "say <message>",
    category: "CoreInfo",
    ...
    const embed = new MessageEmbed()
      .setColor("RANDOM")
      .setTitle("__**Fall Music - Terms of Service**__")
      .setDescription('\nFall Music has access to the End User Data through the Discord API, but Fall Music does not collect, use and/or disclose End User Data except (a) as necessary to exercise your rights under this Agreement, (b) in accordance with Discord’s Privacy Policy.' +
      ...
      '\n\nBy using Fall Music you expressly agree to this Agreement. And by using Discord you expressly agree to Discord’s [Terms of Service](https://discordapp.com/terms), [Guidelines](https://discordapp.com/guidelines) and [Privacy Policy](https://discordapp.com/privacy).' +
